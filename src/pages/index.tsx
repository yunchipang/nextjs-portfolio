  ...
  return (
    <Layout home>
      ...
      <section className={utilStyles.headingMd}>
        ...
        <p>
          👩🏻‍🎓 a software engineer based in boston, with hands-on experience in
          data platform and large-scale processing systems.
        </p>
        <p>
        ...
        <p>
          🕺🏻 when i am not coding, i hit the gym, dance, snowboard, cook & camp
          in the outdoors.
        </p>
        <p>
